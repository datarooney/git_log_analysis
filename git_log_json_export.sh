...
git log --date=iso --numstat --pretty=format:'"},{"header": "%h","author": "%an","author_date": "%ad","committer": "%cn","commit_date": "%cd","numstat": "' | sed -r 's/([0-9]{4}-[0-9]{2}-[0-9]{2})\s([0-9]{2}:[0-9]{2}:[0-9]{2})\s([-|+][0-9]{2})([0-9]{2})/\1T\2\3:\4/g' | tr -s '\r\n\t' ',,,' | \
